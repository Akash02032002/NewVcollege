...
if(isset($_POST['register'])) {
    ...
    if($password !== $confirm_password){
        ...
        if($check->rowCount() > 0){
            ...
            $sql = "INSERT INTO admins (name, mobile, email, password) VALUES (:name, :mobile, :email, :password)";
...
<div class="card shadow-lg">
    <div class="card-header p-3"><h4><i class="bi bi-shield-lock"></i> Admin Registration</h4></div>
